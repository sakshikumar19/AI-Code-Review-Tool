...
class RecommendationGenerator:
    ...
    def _generate_llm_recommendations(self, diff: str, file_path: str, similar_code: List[Dict[str, Any]]) -> List[Dict[str, Any]]:
        ...
        prompt_template = PromptTemplate(
            ...
            template="""
            You are a code review expert analyzing a code change. Please provide recommendations for improving 
            the code based on the diff and similar code in the repository.
            ...
            Analyze the following diff of file {file_path}:
            ```diff
            {diff}
            ```
            ...
            Provide up to 3 specific, actionable recommendations. Each recommendation should be concise 
            and include:
            - A clear issue description
            - A specific suggestion for improvement
            - A severity level (high, medium, or low)
            
            Format your response as a JSON list of recommendations, e.g.:
            [
                {{"type": "llm", "subtype": "performance", "message": "Issue description", "suggestion": "Suggestion", "severity": "medium"}},
                ...
            ]
            """
        )
